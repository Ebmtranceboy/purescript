...
(function($PS) {
  ...
  var lastInput = function (document) {
  ...
  var firstInput = function (document) {
      return function __do() {
          var v = Web_DOM_Document.createElement("input")(document)();
          Web_DOM_Element.setAttribute("type")("text")(v)();
          return v;
  ...
  var loadSavedData = function __do() {
      ...
      if (savedData instanceof Data_Either.Left) {
          Effect_Alert.alert("Unable to read saved form data: " + Data_Foldable.foldMap(Data_List_Types.foldableNonEmptyList)(Data_Monoid.monoidString)(function ($57) {
              return (function (v1) {
                  return "\x0a" + v1;
              })(Foreign.renderForeignError($57));
          })(savedData.value0))();
          return Data_Maybe.Nothing.value;
      };
      ...
      throw new Error("Failed pattern match at Main (line 58, column 3 - line 62, column 33): " + [ savedData.constructor.name ]);
  };
  ...
  var controls = function (node) {
      return function (document) {
          var onClick = function (event) {
              return function __do() {
                  var v = Web_DOM_NonElementParentNode.getElementById("first")(Web_DOM_Document.toNonElementParentNode(document))();
                  var v1 = Data_Traversable.traverse(Data_Traversable.traversableMaybe)(Effect.applicativeEffect)(Web_HTML_HTMLInputElement.value)(Web_HTML_HTMLInputElement.fromElement(Data_Maybe.fromJust()(v)))();
                  var v2 = Web_DOM_NonElementParentNode.getElementById("last")(Web_DOM_Document.toNonElementParentNode(document))();
                  var v3 = Data_Traversable.traverse(Data_Traversable.traversableMaybe)(Effect.applicativeEffect)(Web_HTML_HTMLInputElement.value)(Web_HTML_HTMLInputElement.fromElement(Data_Maybe.fromJust()(v2)))();
                  var rec = {
                      firstName: Data_Maybe.fromJust()(v1),
                      lastName: Data_Maybe.fromJust()(v3)
                  };
                  return Effect_Storage.setItem("person")(Foreign_Generic.encodeJSON(encodeFormData)(rec))();
              };
          };
          return function __do() {
              var v = firstInput(document)();
              var v1 = Web_DOM_Element.setId("first")(v)();
              var v2 = lastInput(document)();
              var v3 = Web_DOM_Element.setId("last")(v2)();
              var v4 = button("Save")(onClick)(document)();
              var v5 = loadSavedData();
              var v6 = label(Data_Show.show(Data_Maybe.showMaybe(showFormData))(v5))(document)();
              Data_Functor["void"](Effect.functorEffect)(Web_DOM_Node.appendChild(Web_DOM_Element.toNode(v))(node))();
              Data_Functor["void"](Effect.functorEffect)(Web_DOM_Node.appendChild(Web_DOM_Element.toNode(v2))(node))();
              Data_Functor["void"](Effect.functorEffect)(Web_DOM_Node.appendChild(Web_DOM_Element.toNode(v4))(node))();
              return Data_Functor["void"](Effect.functorEffect)(Web_DOM_Node.appendChild(Web_DOM_Element.toNode(v6))(node))();
          };
      };
  };
  var main = Data_Functor["void"](Effect.functorEffect)(function __do() {
      ...
      return controls(Web_HTML_HTMLElement.toNode(Data_Maybe.fromJust()(v2)))(document)();
  });
  exports["FormData"] = FormData;
  exports["loadSavedData"] = loadSavedData;
  exports["firstInput"] = firstInput;
  exports["lastInput"] = lastInput;
