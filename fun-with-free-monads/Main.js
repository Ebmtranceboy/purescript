...
(function($PS) {
  ...
  var myShow = function (dictShow) {
      return new Data_Show.Show(function (v) {
          if (v instanceof Zero) {
              return "Zero";
          };
          if (v instanceof One) {
              return "One " + Data_Show.show(dictShow)(v.value0);
          };
          if (v instanceof Two) {
              return "Two " + (Data_Show.show(dictShow)(v.value0) + (" " + Data_Show.show(dictShow)(v.value1)));
          };
          throw new Error("Failed pattern match at Main (line 24, column 1 - line 27, column 53): " + [ v.constructor.name ]);
      });
  };
  var myFunctor = new Data_Functor.Functor(function (f) {
      return function (v) {
          if (v instanceof Zero) {
              return Zero.value;
          };
          if (v instanceof One) {
              return new Two(f(v.value0), f(v.value0));
          };
          if (v instanceof Two) {
              return new One(f(v.value1));
          };
          throw new Error("Failed pattern match at Main (line 29, column 1 - line 32, column 30): " + [ f.constructor.name, v.constructor.name ]);
      };
  });
  var liftFree = function (dictFunctor) {
      return function (x) {
          return new Roll(Data_Functor.map(dictFunctor)(Pure.create)(x));
      };
  };
  var freeShow = function (dictShow) {
      return new Data_Show.Show(function (v) {
          if (v instanceof Pure) {
              return "Pure " + Data_Show.show(dictShow)(v.value0);
          };
          if (v instanceof Roll) {
              return "Roll";
          };
          throw new Error("Failed pattern match at Main (line 36, column 1 - line 38, column 25): " + [ v.constructor.name ]);
      });
  };
  var freeFunctor = function (dictFunctor) {
      return new Data_Functor.Functor(function (f) {
          return function (v) {
              if (v instanceof Pure) {
              ...
              if (v instanceof Roll) {
                  return new Roll(Data_Functor.map(dictFunctor)(Data_Functor.map(freeFunctor(dictFunctor))(f))(v.value0));
              };
              throw new Error("Failed pattern match at Main (line 41, column 1 - line 43, column 40): " + [ f.constructor.name, v.constructor.name ]);
          };
      });
  };
  var foldFree = function (dictFunctor) {
      return function (v) {
          return function (v1) {
              ...
              if (v1 instanceof Roll) {
                  return v(Data_Functor.map(dictFunctor)(foldFree(dictFunctor)(v))(v1.value0));
              };
              throw new Error("Failed pattern match at Main (line 66, column 1 - line 66, column 65): " + [ v.constructor.name, v1.constructor.name ]);
          };
      };
  };
  var extract = function (dictMonoid) {
      return function (v) {
          if (v instanceof Zero) {
              return Data_Monoid.mempty(dictMonoid);
          };
          ...
          if (v instanceof Two) {
              return Data_Semigroup.append(dictMonoid.Semigroup0())(v.value0)(v.value1);
          };
          throw new Error("Failed pattern match at Main (line 70, column 1 - line 70, column 43): " + [ v.constructor.name ]);
      };
  };
  var concatFree = function (dictFunctor) {
      return function (v) {
          if (v instanceof Pure) {
              return v.value0;
          };
          if (v instanceof Roll) {
              return new Roll(Data_Functor.map(dictFunctor)(concatFree(dictFunctor))(v.value0));
          };
          throw new Error("Failed pattern match at Main (line 45, column 1 - line 45, column 69): " + [ v.constructor.name ]);
      };
  };
  var cb = function (v) {
      return function (ev) {
  ...
  var bindFree = function (dictFunctor) {
      return function (x) {
          return function (f) {
              return concatFree(dictFunctor)(Data_Functor.map(freeFunctor(dictFunctor))(f)(x));
          };
      };
  };
  var freeApply = function (dictFunctor) {
      return new Control_Apply.Apply(function () {
          return freeFunctor(dictFunctor);
      }, function (ff) {
          return function (fx) {
              return bindFree(dictFunctor)(fx)(function (x) {
                  return bindFree(dictFunctor)(ff)(function (f) {
                      return Pure.create(f(x));
                  });
              });
          };
      });
  };
  var freeApplicative = function (dictFunctor) {
      return new Control_Applicative.Applicative(function () {
          return freeApply(dictFunctor);
      }, Pure.create);
  };
  var freeBind = function (dictFunctor) {
      return new Control_Bind.Bind(function () {
          return freeApply(dictFunctor);
      }, function (x) {
          return function (f) {
              return bindFree(dictFunctor)(x)(f);
          };
      });
  };
  var test0 = Control_Bind.bind(freeBind(myFunctor))(Data_Functor.map(freeFunctor(myFunctor))(function (x) {
      return x + x;
  })(liftFree(myFunctor)(new One("A"))))(function (v) {
      return Control_Applicative.pure(freeApplicative(myFunctor))(v);
  });
  var test1 = Control_Bind.bind(freeBind(myFunctor))(Data_Functor.map(freeFunctor(myFunctor))(function (x) {
      return Data_Semigroup.append(Data_Semigroup.semigroupArray)(x)(x);
  })(liftFree(myFunctor)(new Two([ 12 ], [ 5 ]))))(function (v) {
      return Control_Applicative.pure(freeApplicative(myFunctor))(v);
  });
  exports["Zero"] = Zero;
  exports["One"] = One;
  ...
  exports["cb"] = cb;
  exports["main"] = main;
  exports["myShow"] = myShow;
  exports["myFunctor"] = myFunctor;
  exports["freeShow"] = freeShow;
