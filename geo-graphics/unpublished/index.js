  ...
  var main = Data_Functor["void"](Effect.functorEffect)(function __do() {
      ...
      if (v1 instanceof Data_Maybe.Just) {
          ...
          var draw = function (dictDrawableSet) {
              var $51 = Graphics_Drawing.render(v4);
              var $52 = Graphics_Canvas_Geometry.drawIn(dictDrawableSet)(ctx);
              return function ($53) {
                  return $51($52($53));
              };
          };
          var a = Graphics_Canvas_Geometry.point("A")(310.0)(320.0);
          var b = Graphics_Canvas_Geometry.point("B")(100.0)(210.0);
          draw(Graphics_Canvas_Geometry.drawableSequence(Graphics_Canvas_Geometry.drawablePoint))([ a, b ])();
          draw(Graphics_Canvas_Geometry.drawableLine)(Graphics_Canvas_Geometry.line(a)(b))();
          var c = Graphics_Canvas_Geometry.circle(a)(Graphics_Canvas_Geometry.length(Graphics_Canvas_Geometry.measurableVector)(Graphics_Canvas_Geometry.vector(a)(b)));
          draw(Graphics_Canvas_Geometry.drawableCircle)(c)();
          var n = Graphics_Canvas_Geometry.normalTo(Graphics_Canvas_Geometry.vector(a)(b));
          var d = Graphics_Canvas_Geometry.halfline(a)(n);
          draw(Graphics_Canvas_Geometry.drawableHalfLine)(d)();
          var v5 = Data_Functor.map(Data_Functor.functorArray)(Graphics_Canvas_Geometry.rename("E"))(Graphics_Canvas_Geometry.meets(Graphics_Canvas_Geometry.interHalfLineCircle)(d)(c));
          if (v5.length === 1) {
              draw(Graphics_Canvas_Geometry.drawablePoint)(v5[0])();
              var eb = Graphics_Canvas_Geometry.segment(v5[0])(b)(Data_Maybe.Nothing.value);
              draw(Graphics_Canvas_Geometry.drawableSegment)(eb)();
              var i = Graphics_Canvas_Geometry.middle("I")(eb);
              draw(Graphics_Canvas_Geometry.drawablePoint)(i)();
              var v6 = Data_Functor.map(Data_Functor.functorArray)(Graphics_Canvas_Geometry.rename("F"))(Graphics_Canvas_Geometry.meets(Graphics_Canvas_Geometry.interCircleHalfLine)(c)(Graphics_Canvas_Geometry.halfline(a)(Graphics_Canvas_Geometry.vector(b)(a))));
              if (v6.length === 1) {
                  draw(Graphics_Canvas_Geometry.drawablePoint)(v6[0])();
                  Graphics_Drawing.render(v4)(Graphics_Canvas_Geometry.drawIn(Graphics_Canvas_Geometry.drawableSegment)({
                      color: ctx.color,
                      lineWidth: 5.0
                  })(Graphics_Canvas_Geometry.segment(i)(v6[0])(new Data_Maybe.Just("u"))))();
                  var orientedArc = Graphics_Canvas_Geometry.arc(Graphics_Canvas_Geometry.vector(i)(v6[0]))(i)(Graphics_Canvas_Geometry.vector(i)(b))(50.0)(false)(false)(new Data_Maybe.Just("\u03b1"));
                  draw(Graphics_Canvas_Geometry.drawableArc)(orientedArc)();
                  var g = Graphics_Canvas_Geometry.circle(v6[0])(Graphics_Canvas_Geometry.length(Graphics_Canvas_Geometry.measurableVector)(Graphics_Canvas_Geometry.vector(i)(v5[0])));
                  draw(Graphics_Canvas_Geometry.drawableCircle)(g)();
                  var v7 = Graphics_Canvas_Geometry.meets(Graphics_Canvas_Geometry.interCircleCircle)(g)(c);
                  if (v7.length === 2) {
                      draw(Graphics_Canvas_Geometry.drawableSequence(Graphics_Canvas_Geometry.drawablePoint))([ v7[0], v7[1] ])();
                      var v8 = Data_Functor.map(Data_Functor.functorArray)(Graphics_Canvas_Geometry.rename("H"))(Graphics_Canvas_Geometry.meets(Graphics_Canvas_Geometry.interLineLine)(Graphics_Canvas_Geometry.line(a)(v5[0]))(Graphics_Canvas_Geometry.line(i)(v6[0])));
                      if (v8.length === 1) {
                          draw(Graphics_Canvas_Geometry.drawablePoint)(v8[0])();
                          draw(Graphics_Canvas_Geometry.drawRightAngle)(Graphics_Canvas_Geometry.rightangle(Graphics_Canvas_Geometry.vector(a)(b))(a)(Graphics_Canvas_Geometry.vector(a)(v5[0]))(15.0))();
                          var v9 = Graphics_Canvas_Geometry.meets(Graphics_Canvas_Geometry.interSegmentSegment)(Graphics_Canvas_Geometry.segment(b)(v8[0])(Data_Maybe.Nothing.value))(Graphics_Canvas_Geometry.segment(v5[0])(v6[0])(Data_Maybe.Nothing.value));
                          if (v9.length === 0) {
                              var v10 = Data_Functor.map(Data_Functor.functorArray)(Graphics_Canvas_Geometry.rename("J"))(Graphics_Canvas_Geometry.meets(Graphics_Canvas_Geometry.interHalfLineSegment)(Graphics_Canvas_Geometry.halfline(b)(Graphics_Canvas_Geometry.vector(b)(v8[0])))(Graphics_Canvas_Geometry.segment(v5[0])(v6[0])(Data_Maybe.Nothing.value)));
                              if (v10.length === 1) {
                                  draw(Graphics_Canvas_Geometry.drawablePoint)(v10[0])();
                                  Graphics_Drawing.render(v4)(Graphics_Canvas_Geometry.drawIn(Graphics_Canvas_Geometry.drawableSegment)({
                                      color: ctx.color,
                                      lineWidth: 0.5
                                  })(Graphics_Canvas_Geometry.segment(i)(v10[0])(new Data_Maybe.Just(""))))();
                                  return Data_Unit.unit;
                              };
                              throw new Error("Failed pattern match at Main (line 65, column 7 - line 66, column 52): " + [ v10.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 64, column 7 - line 64, column 63): " + [ v9.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main (line 60, column 7 - line 60, column 59): " + [ v8.constructor.name ]);
                  };
                  throw new Error("Failed pattern match at Main (line 58, column 7 - line 58, column 28): " + [ v7.constructor.name ]);
              };
              throw new Error("Failed pattern match at Main (line 49, column 7 - line 49, column 65): " + [ v6.constructor.name ]);
          };
          throw new Error("Failed pattern match at Main (line 42, column 7 - line 42, column 43): " + [ v5.constructor.name ]);
      };
