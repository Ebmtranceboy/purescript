      ...
      return function (ev) {
          return function (node) {
              return function __do() {
                  ...
                  return Web_Event_EventTarget.addEventListener(ev)(v)(false)(Web_DOM_Element.toEventTarget(Data_Maybe.fromJust()(Web_DOM_Element.fromNode(node))))();
              };
          };
      };
  };
  ...
  var main = function __do() {
      ...
      var v13 = DOM_Editor.addEventListener(function (ev) {
          return function __do() {
              ...
              var v15 = DOM_Editor.removeChild(v11)();
              return Data_Unit.unit;
          };
