...
(function($PS) {
  ...
  var genericMaybe = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Main (line 25, column 1 - line 25, column 48): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var changedInput = function (node) {
          ...
          return function (event) {
              var reader = function (f) {
                  return Data_Functor["void"](Effect.functorEffect)(Effect_Aff.runAff(function (v) {
                      ...
                      return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(DOM_Editor.setTextContent(v)(area));
                  })));
              };
              return function __do() {
                  Data_Functor["void"](Effect.functorEffect)(Control_Monad_Maybe_Trans.runMaybeT(Control_Bind.bind(Control_Monad_Maybe_Trans.bindMaybeT(Effect.monadEffect))(Control_Monad_Maybe_Trans.MaybeT(Web_HTML_HTMLInputElement.files(node)))(function (v) {
  ...
  var main = function __do() {
      ...
      var v1 = DOM_Editor.createElement("textarea")(v.document)();
      var v2 = DOM_Editor.setAttribute("cols")("80")(v1)();
      var v3 = DOM_Editor.setAttribute("rows")("25")(v1)();
      var v4 = DOM_Editor.createElement("input")(v.document)();
      var v5 = DOM_Editor.setAttribute("type")("file")(v4)();
      var v6 = DOM_Editor.addEventListener(changedInput(Data_Maybe.fromJust()(Web_HTML_HTMLInputElement.fromNode(v4)))(v1))(DOM_Editor.change)(v4)();
      var v7 = DOM_Editor.appendChild(v4)(v.body)();
      var v8 = DOM_Editor.appendChild(v1)(v.body)();
