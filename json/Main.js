...
(function($PS) {
  ...
  var genericMaybe = new Data_Generic_Rep.Generic(function (x) {
      ...
      throw new Error("Failed pattern match at Main (line 16, column 1 - line 16, column 48): " + [ x.constructor.name ]);
  }, function (x) {
  ...
  var main = function __do() {
      ...
      var v2 = DOM_Editor.createElement("textarea")(v.document)();
      var v3 = DOM_Editor.setAttribute("cols")("80")(v2)();
      var v4 = DOM_Editor.setAttribute("rows")("25")(v2)();
      var v5 = DOM_Editor.appendChild(v2)(v1)();
      var v6 = DOM_Editor.createElement("div")(v.document)();
      var v7 = DOM_Editor.appendChild(v6)(v1)();
      var v8 = DOM_Editor.createElement("button")(v.document)();
      var v9 = DOM_Editor.setTextContent("Save")(v8)();
      var v10 = DOM_Editor.appendChild(v8)(v1)();
      var v11 = DOM_Editor.createElement("input")(v.document)();
      var v12 = DOM_Editor.setAttribute("type")("file")(v11)();
      var v13 = DOM_Editor.addEventListener(function (ev) {
          return function __do() {
              DOM_Editor.withTextReader(function (json) {
                  return function __do() {
                      var v13 = DOM_Editor.setTextContent(json)(v2)();
                      var v14 = DOM_Editor.setTextContent(Data_Show.show(Data_Either.showEither(Data_List_Types.showNonEmptyList(Foreign.showForeignError))(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "record";
                          ...
                          return "key1";
                      }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.intDecode))()))))()))(json))))(v6)();
                      return Data_Unit.unit;
                  };
              })(ev)();
              var v13 = DOM_Editor.fileName(v11)();
              var v14 = DOM_Editor.addEventListener(function (_ev) {
                  return function __do() {
                      var v14 = DOM_Editor.dateTimeTag();
                      return v.saveText(v2)(v14 + v13)(_ev)();
                  };
              })(DOM_Editor.click)(v8)();
              return Data_Unit.unit;
          };
      })(DOM_Editor.change)(v11)();
      var v14 = DOM_Editor.appendChild(v11)(v.body)();
      var v15 = DOM_Editor.appendChild(v1)(v.body)();
