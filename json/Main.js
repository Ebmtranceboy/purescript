...
(function($PS) {
  ...
  var main = function __do() {
      ...
      var v7 = DOM_Editor.createElement("div")(v.document)();
      var v8 = DOM_Editor.appendChild(v7)(v2)();
      var v9 = DOM_Editor.createElement("input")(v.document)();
      var v10 = DOM_Editor.setAttribute("type")("file")(v9)();
      var v11 = DOM_Editor.addEventListener(function (ev) {
          return function __do() {
              DOM_Editor.withTextReader(function (json) {
                  return function __do() {
                      var v11 = DOM_Editor.setTextContent(json)(v3)();
                      var v12 = DOM_Editor.setTextContent(Data_Show.show(Data_Either.showEither(Data_List_Types.showNonEmptyList(Foreign.showForeignError))(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "record";
                          ...
                          return "key2";
                      }))(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showInt)))))))(Control_Monad_Except.runExcept(Foreign_Generic.decodeJSON(Foreign_Generic_Class.recordDecode()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordNil)(new Data_Symbol.IsSymbol(function () {
                          return "status";
                      }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.booleanDecode))())(new Data_Symbol.IsSymbol(function () {
                          return "record";
                      }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.arrayDecode(Foreign_Generic_Class.recordDecode()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordCons()(Foreign_Generic_Class.decodeRecordNil)(new Data_Symbol.IsSymbol(function () {
                          return "key2";
                      }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.stringDecode))())(new Data_Symbol.IsSymbol(function () {
                          return "key1";
                      }))(Foreign_Generic_Class.decodeWithOptionsOther(Foreign_Generic_Class.intDecode))()))))()))(json))))(v7)();
                      return Data_Unit.unit;
                  };
              })(ev)();
              var v11 = DOM_Editor.createElement("button")(v.document)();
              var v12 = DOM_Editor.setTextContent("Save")(v11)();
              var v13 = DOM_Editor.fileName(v9)();
              var v14 = DOM_Editor.addEventListener(save(v3)(v1 + v13)(v))(DOM_Editor.click)(v11)();
              var v15 = DOM_Editor.appendChild(v11)(v2)();
              return Data_Unit.unit;
          };
      })(DOM_Editor.change)(v9)();
      var v12 = DOM_Editor.appendChild(v9)(v.body)();
      var v13 = DOM_Editor.appendChild(v2)(v.body)();
