...
(function($PS) {
  ...
  var boardHandler = function (b) {
      ...
      return {
          ...
          board: dropRows(Data_Foldable.foldl(Data_Foldable.foldableArray)(clearRow)(b)(full))
      };
  };
  ...
  var guardTransform = function (b) {
      return function (f) {
          return function (p) {
              var $128 = wallCollision(f(p)) || (floorCollision(f(p)) || boardCollision(f(p))(b));
              if ($128) {
                  return p;
              };
              return f(p);
          ...
          var state = FRP_Behavior.unfold(FRP_Event.eventIsEvent)(function (code) {
              return function (st) {
                  ...
                  if ($172) {
                      ...
                      var $174 = floorCollision(p$prime) || boardCollision(p$prime)(st.currentGame.board);
                      if ($174) {
