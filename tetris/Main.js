...
(function($PS) {
  ...
  var lowestUnused = function (b) {
      return Data_Array.head(unusedRows(b));
  };
  var gameColumns = 10;
  ...
  var dropRow = function (b) {
      return function (j) {
          var v = lowestUnused(b);
          if (v instanceof Data_Maybe.Just) {
              var $124 = v.value0 < j;
              if ($124) {
                  return Data_Maybe.Just.create(changeRow(j)(v.value0)(b));
              };
  ...
  var dropRows = function (b) {
      return Data_Array.foldM(Data_Maybe.monadMaybe)(dropRow)(b)(Data_Array.range(0)(vertbounds));
  };
  ...
  var boardHandler = function (b) {
      var full = fullRows(b);
      return {
          gain: Data_Array.length(full),
          maybeBoard: dropRows(Data_Foldable.foldl(Data_Foldable.foldableArray)(clearRow)(b)(full))
      };
  };
  ...
  var guardTransform = function (b) {
      return function (f) {
          return function (p) {
              var $131 = wallCollision(f(p)) || (floorCollision(f(p)) || boardCollision(f(p))(b));
              if ($131) {
                  return p;
              };
              return f(p);
  ...
  var renderState = function (v) {
      var squareToBox = function (offx) {
          return function (offy) {
              return function (v1) {
                  var origy = Data_Int.toNumber(offy - v1.pos.y | 0) * side;
                  var origx = Data_Int.toNumber(v1.pos.x + offx | 0) * side;
                  var color = Color.rgb(v1.col.r)(v1.col.g)(v1.col.b);
                  var var1 = Color.lighten(0.2)(color);
                  var var2 = Color.lighten(-0.1)(color);
                  var var3 = Color.lighten(-0.2)(color);
                  var var4 = Color.lighten(-0.3)(color);
                  return Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(Graphics_Drawing.filled(Graphics_Drawing.fillColor(color))(Graphics_Drawing.rectangle(origx + biseau)(origy + biseau)(side - 2.0 * biseau)(side - 2.0 * biseau)))(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(Graphics_Drawing.filled(Graphics_Drawing.fillColor(var1))(Graphics_Drawing.closed(Data_Foldable.foldableArray)([ {
                      x: origx,
                      y: origy
                  }, {
                      x: origx + side,
                      ...
                      x: origx + biseau,
                      y: origy + biseau
                  } ])))(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(Graphics_Drawing.filled(Graphics_Drawing.fillColor(var2))(Graphics_Drawing.closed(Data_Foldable.foldableArray)([ {
                      x: origx + side,
                      y: origy
                  }, {
                      x: (origx + side) - biseau,
                      ...
                      x: origx + side,
                      y: origy + side
                  } ])))(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing)(Graphics_Drawing.filled(Graphics_Drawing.fillColor(var3))(Graphics_Drawing.closed(Data_Foldable.foldableArray)([ {
                      x: origx,
                      y: origy
                  }, {
                      x: origx + biseau,
                      ...
                      x: origx,
                      y: origy + side
                  } ])))(Graphics_Drawing.filled(Graphics_Drawing.fillColor(var4))(Graphics_Drawing.closed(Data_Foldable.foldableArray)([ {
                      x: (origx + side) - biseau,
                      y: (origy + side) - biseau
                  }, {
                      x: origx + side,
      ...
      var blood = Graphics_Drawing.fillColor(Color.rgb(200)(10)(20));
      var black = Graphics_Drawing.fillColor(Color.rgb(0)(0)(0));
      return Data_Foldable.foldr(Data_Foldable.foldableArray)(Data_Semigroup.append(Graphics_Drawing.semigroupDrawing))(Data_Monoid.mempty(Graphics_Drawing.monoidDrawing))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(squareToBox(5)(23))(whiteSquares))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(squareToBox(5)(23))(v.currentGame.board))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(squareToBox(5)(23))(pieceToSquares(v.currentGame.piece)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)(Data_Functor.map(Data_Functor.functorArray)(squareToBox(-2 | 0)(29))(pieceToSquares(v.nextPiece)))(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ Graphics_Drawing.text(Graphics_Drawing_Font.font(Graphics_Drawing_Font.monospace)(50)(Graphics_Drawing_Font.bold))(40.0)(50.0)(Graphics_Drawing.fillColor(Color.rgb(70)(70)(70)))(Data_Show.show(Data_Show.showInt)(v.score)) ])((function () {
          if (v.gameOver) {
              return [ Graphics_Drawing.text(Graphics_Drawing_Font.font(Graphics_Drawing_Font.fantasy)(65)(Graphics_Drawing_Font.bold))(45.0)(265.0)(black)("GAME"), Graphics_Drawing.text(Graphics_Drawing_Font.font(Graphics_Drawing_Font.fantasy)(65)(Graphics_Drawing_Font.bold))(45.0)(335.0)(black)("OVER!!"), Graphics_Drawing.text(Graphics_Drawing_Font.font(Graphics_Drawing_Font.fantasy)(64)(Graphics_Drawing_Font.bold))(50.0)(270.0)(blood)("GAME"), Graphics_Drawing.text(Graphics_Drawing_Font.font(Graphics_Drawing_Font.fantasy)(64)(Graphics_Drawing_Font.bold))(50.0)(340.0)(blood)("OVER!!") ];
          };
          return [  ];
      })()))))));
  };
          ...
          var state = FRP_Behavior.unfold(FRP_Event.eventIsEvent)(function (code) {
              return function (st) {
                  ...
                  if ($177) {
                      ...
                      var $179 = floorCollision(p$prime) || boardCollision(p$prime)(st.currentGame.board);
                      if ($179) {
                          var v2 = boardHandler(addToBoard(st.currentGame.piece)(st.currentGame.board));
                          if (v2.maybeBoard instanceof Data_Maybe.Just) {
                              return {
                                  currentSeed: v1.gen,
                                  nextPiece: v1.val,
                                  currentGame: {
                                      piece: st.nextPiece,
                                      board: v2.maybeBoard.value0
                                  },
                                  score: st.score + v2.gain | 0,
                                  gameOver: st.gameOver
                              };
                          };
                          return {
                              gameOver: true,
                              currentGame: st.currentGame,
